 ...
 * 
 */
export const HeroBlockComponent : CmsComponent<HeroBlockDataFragment> = ({ data, editProps }) => {
    const componentName = 'Hero Block'
    const componentInfo = ''
...
HeroBlockComponent.displayName = "Hero Block (Component/HeroBlock)"
